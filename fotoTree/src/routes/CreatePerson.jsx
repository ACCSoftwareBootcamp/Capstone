...
//             `http://localhost:5001/tree/${userData._id}`
//           );
...
const CreatePerson = () => {
  ...
  // Combined image upload + person creation
  const handleAddPerson = async (e) => {
    ...
    // Build person object including uploaded photoArray
    const personObj = {
      treeId,
      firstName: formData.firstName,
      lastName: formData.lastName,
      creator: mongoUser,
      photoArray, // <-- this will be empty string if no file
    };
    ...
    try {
      ...
      setFormData({ firstName: "", lastName: "", birthDate: "", partnerId: "", bio: "" });
      setFile(null);
